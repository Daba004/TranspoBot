...
<body class="h-full font-sans text-slate-700">
    <div class="min-h-full flex">
        <!-- Sidebar -->
        <aside class="w-72 bg-[#064e3b] flex-shrink-0 hidden md:flex flex-col relative overflow-hidden">
            <!-- Decorative Background Element -->
            <div class="absolute -top-24 -left-24 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl"></div>
            
            <div class="p-8 relative z-10">
                <div class="flex items-center gap-3">
                    <div class="w-11 h-11 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-emerald-900/20">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                    </div>
                    <span class="text-2xl font-display font-black text-white tracking-tight">Transpo<span class="text-emerald-400">Bot</span></span>
                </div>
            </div>
            ...
            <nav class="flex-1 px-4 space-y-1.5 mt-4 relative z-10">
                ...
                <a href="incidents.php" class="flex items-center px-4 py-3.5 text-sm font-semibold rounded-xl transition-all <?php echo basename($_SERVER['PHP_SELF']) == 'incidents.php' ? 'bg-white/10 text-white border-l-4 border-amber-400 pl-3' : 'text-emerald-100/60 hover:bg-white/5 hover:text-white'; ?>">
                    ...
                    ?>
                        <span class="ml-auto bg-amber-400 text-emerald-900 text-[10px] px-1.5 py-0.5 rounded-full font-black"><?php echo $unresolved_count; ?></span>
                    <?php endif; ?>
                </a>
            </nav>
            ...
            <div class="p-4 mt-auto">
                <div class="bg-slate-900 rounded-2xl p-4 text-white">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-semibold">Connecté</span>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#f4f7f6]">
            <!-- Header -->
            <header class="h-20 bg-white/70 backdrop-blur-md border-b border-slate-200/60 flex items-center justify-between px-8 flex-shrink-0 sticky top-0 z-40">
                <div>
                    <h1 class="text-xl font-display font-black text-emerald-950 tracking-tight">
                        <?php 
                    ...
                    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">TranspoBot Management System</p>
                </div>
                <div class="flex items-center gap-6">
                    <button class="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex items-center gap-3 pl-6 border-l border-slate-200">
                        <div class="text-right">
                            ...
                            <p class="text-[10px] text-emerald-600 font-black tracking-widest uppercase italic">Master</p>
                        </div>
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-slate-200 to-slate-300 border-2 border-white shadow-sm overflow-hidden">
