...
<div class="bg-white rounded-2xl border border-slate-200/60 overflow-hidden shadow-lg shadow-slate-200/30 flex-1 flex flex-col min-h-0">
    <div class="p-6 flex justify-between items-center bg-white/50 backdrop-blur-sm shrink-0">
        ...
        <button onclick="addIncident()" class="bg-rose-600 text-white px-4 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-rose-700 hover:shadow-lg transition-all flex items-center gap-2">
            ...
            <tbody class="text-sm divide-y divide-slate-100">
                ...
                <tr class="group hover:bg-emerald-50/40 transition-all duration-300">
                    ...
                    <td class="px-6 py-4 text-right whitespace-nowrap space-x-1">
                        ...
                        <?php endif; ?>
                        <form action="actions/incident_action.php" method="POST" class="inline" onsubmit="return confirm('Supprimer cet incident ?');">
                            <input type="hidden" name="action" value="delete">
                            <input type="hidden" name="id" value="<?php echo $i['id']; ?>">
                            <button type="submit" class="bg-white text-rose-600 px-3 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-rose-600 hover:text-white hover:shadow-lg transition-all border border-rose-200">
                                Sup.
                            </button>
                        </form>
                    </td>
